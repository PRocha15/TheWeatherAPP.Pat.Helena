...
namespace TheWeatherAPP.Pat.Helena.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(TheWeatherAPPPatHelenaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Users != null ? 
                          ...
                          Problem("Entity set 'TheWeatherAPPPatHelenaContext.Users'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TheWeatherAPPPatHelenaContext.Users'  is null.");
            }
            var users = await _context.Users.FindAsync(id);
            if (users != null)
            {
